...
class customer(person):
    def __init__(self, age, name, adress, customer_id, **kwargs):    # Fix: Pass the arguments you captured to the super() call
    ...
    def open_account(self, account_type, initial_deposit, account_number, interest_rate=0):
        ...
        elif account_type == 'current':  # Note: You named this CurrentAccount, not CheckingAccount
...
class BankManager(employee, customer):
    def __init__(self, name, age, adress, customer_id, employee_id, salary, manager_level):
        ...
        print("--- BankManager Created ---")# ... rest of the methods
